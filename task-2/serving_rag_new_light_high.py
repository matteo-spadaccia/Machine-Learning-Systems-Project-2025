...
MAX_BATCH_SIZE = 16     # Setting the desired maximum number of requests per batch [or 4]
MAX_WAITING_TIME = 4    # Setting the desired maximum time (in seconds) to wait for a batch [or 2]
